...
public class BarbershopGui extends JFrame implements Gui, ChangeListener {
	...
	private void loadImages() {
		...
		wallsImage = loadImage(tk, "src/ov2/images/walls.gif", tracker);
		floorImage = loadImage(tk, "src/ov2/images/floor.gif", tracker);
		loungeChairImage = loadImage(tk, "src/ov2/images/loungechair.gif", tracker);
		barberChairImage = loadImage(tk, "src/ov2/images/barberchair.gif", tracker);
		barberImage = loadImage(tk, "src/ov2/images/barber.gif", tracker);
		customerImages = new Image[Constants.NOF_CUSTOMER_LOOKS];
		for(int i = 0; i < Constants.NOF_CUSTOMER_LOOKS; i++) {
			customerImages[i] = loadImage(tk, "src/ov2/images/customer"+i+".gif", tracker);
		}
		tableImage = loadImage(tk, "src/ov2/images/table.gif", tracker);
		deskImage = loadImage(tk, "src/ov2/images/desk.gif", tracker);
		sleepImage = loadImage(tk, "src/ov2/images/sleep.gif", tracker);
		try {
			tracker.waitForID(0);
